...
/* $Id: sjis_jsky1.c,v 1.3 2005/08/18 10:12:08 hio Exp $ */
...
/* ----------------------------------------------------------------------------
 * SV* sv_utf8 = xs_sjis_jsky1_utf8(SV* sv_sjis)
 * convert sjis(jsky1) into utf8.
 * ------------------------------------------------------------------------- */
EXTERN_C
SV*
  ...
  while( src<src_end )
  {
    ...
    }else if( 0xf0<=*src && *src<=0xf7 )
    {
	  ...
	  continue;
        ...
        /* j-sky1 emoji */
        sjis = &g_eu2j1_table[(ucs - 0x0fe000)*5];
